        ...
        <div>
            <dialog open={shoppingModal} >
                <div>
                    ...
                    {
                        userData ?
                            <button type="button" className="flex items-center justify-center rounded-md border border-transparent bg-second px-6 py-3 text-base font-medium text-primary shadow-sm" onClick={() => handleBuyClick(shoppingList)}>Finalizar pedido</button>
                            :
