...
export const ProductModalEditAdmin = () => {

  const cancelButtonRef = useRef(null);
  const { adminEditModal, setAdminEditModal} = adminStore((state) => state)

  return (
    <Transition.Root show={adminEditModal} as={Fragment}>
      <Dialog
        as="div"
        className="relative z-10"
        initialFocus={cancelButtonRef}
        onClose={setAdminEditModal}
      >
        <Transition.Child
          as={Fragment}
